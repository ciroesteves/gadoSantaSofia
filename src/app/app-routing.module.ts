...
const routes: Routes = [
  ...
  {path: 'detalhes/:id', loadChildren: () => import('./pages/detalhes/detalhes.module').then( m => m.DetalhesPageModule)},
  {path: 'edicao/:id', loadChildren: () => import('./pages/edicao/edicao.module').then( m => m.EdicaoPageModule)},
